...
const Validations = {
    ...
    name : {required: true, message: 'Please enter Name!, Max 50 chars', max: 50},
    ...
    phone_50 : {required: true, message: 'Please enter number phone!, Max 50 chars', max: 50},
    phone_100 : {required: true, message: 'Please enter number phone!, Max 100 chars', max: 100},
    ...
    required: {required: true, message: 'Please select schedule!' },
};
